...
#define VRUI_INTERNAL_CONFIG_LIBDIR_DEBUG "/usr/local/lib/x86_64-linux-gnu/Vrui-14.0/debug"
#define VRUI_INTERNAL_CONFIG_LIBDIR_RELEASE "/usr/local/lib/x86_64-linux-gnu/Vrui-14.0"
...
#define VRUI_INTERNAL_CONFIG_PLUGINDIR_DEBUG "/usr/local/lib/x86_64-linux-gnu/Vrui-14.0/debug"
#define VRUI_INTERNAL_CONFIG_PLUGINDIR_RELEASE "/usr/local/lib/x86_64-linux-gnu/Vrui-14.0"
...
#define VRUI_INTERNAL_CONFIG_TOOLDIR_DEBUG "/usr/local/lib/x86_64-linux-gnu/Vrui-14.0/debug/VRTools"
#define VRUI_INTERNAL_CONFIG_TOOLDIR_RELEASE "/usr/local/lib/x86_64-linux-gnu/Vrui-14.0/VRTools"
#define VRUI_INTERNAL_CONFIG_VISLETDIR_DEBUG "/usr/local/lib/x86_64-linux-gnu/Vrui-14.0/debug/VRVislets"
#define VRUI_INTERNAL_CONFIG_VISLETDIR_RELEASE "/usr/local/lib/x86_64-linux-gnu/Vrui-14.0/VRVislets"
#ifdef DEBUG
...
#define VRUI_INTERNAL_CONFIG_SYSCONFIGDIR "/usr/local/etc/Vrui-14.0"
#define VRUI_INTERNAL_CONFIG_HAVE_USERCONFIGFILE 1
#define VRUI_INTERNAL_CONFIG_USERCONFIGDIR ".config/Vrui-14.0"
#define VRUI_INTERNAL_CONFIG_APPCONFIGDIR "Applications"
#define VRUI_INTERNAL_CONFIG_DEFAULTROOTSECTION "Desktop"

#define VRUI_INTERNAL_CONFIG_VERSION 14000002
#define VRUI_INTERNAL_CONFIG_ETCDIR "/usr/local/etc/Vrui-14.0"
#define VRUI_INTERNAL_CONFIG_SHAREDIR "/usr/local/share/Vrui-14.0"
